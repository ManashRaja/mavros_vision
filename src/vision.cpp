...
public:
	...
	void initialize(UAS &uas_)
	{
		...
		offboard_odom_sub = nh.subscribe("offboard_odom", 10, &OffboardPlugin::offboard_odom_cb, this);
	}
...
{*/
		// ROS right hand convention to GPS
		double start_lat = 22.3155938; double start_lon = 87.3086843;
    ...
    double current_lon = start_lon + (180.0/M_PI)*(-req->pose.pose.position.y/6378137.0)/cos(start_lat);
		...
		mavlink_msg_gps_raw_int_pack(0, 0, &packet,
																 ...
																 (int32_t)(req->pose.pose.position.y*1000),
																 UINT16_MAX,
																 UINT16_MAX,
																 UINT16_MAX,
																 UINT16_MAX,
